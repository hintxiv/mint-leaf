export const en = {
    ...
    editor: {
        timing: 'Timing',
        editName: 'Edit action name',
        actionName: 'Action name',
        lateWeave: 'Late weave',
        removeStatus: 'Remove status',
        shareGcd: 'Share with matching GCDs',
        sharedValue: 'Recast edits apply to all GCDs with the same base recast.',
        specificValue: 'Recast edits are saved for this action only.',
